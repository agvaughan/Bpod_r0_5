...
for currentTrial = 1:MaxTrials
    ...
    Sound1 = GenerateSineWave(SF, S.GUI.SinWaveFreq1, S.SoundDuration1);
    PsychToolboxSoundServer('Load', 1, Sound1);
    ...
    switch DirectDelivery 
        ...
        sma = AddState(sma, 'Name', 'WaitForPunishLick', ...
            'Timer', S.GUI.StimulusDuration,...
            'StateChangeConditions', {'Tup', 'WaitForRewardLick' },...
            'OutputActions', {});
    end
    ...
    sma = AddState(sma, 'Name', 'Punish', ...
        ...
        'OutputActions', {'ValveState', S.PunishValveCode,'SoftCode',255});  %maybe WN & LED are just during training
