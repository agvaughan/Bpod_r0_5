...
function OutcomePlot_LickWithholding(AxesHandle, Action, varargin)
%% 
...
switch Action
    case 'init'
        ...
        set(AxesHandle,'TickDir', 'out','YLim', [-2, 2], 'YTick', [-1 0 1],'YTickLabel', { 'Type 3','Type 2','Type 1'}, 'FontSize', 16);
